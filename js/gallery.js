...
class Gallery {
    ...
    loadImages() {
        this.images = [
            { src: 'assets/gallery/photo1.jpg', alt: 'Ученики и инструкторы автошколы Мустанг около учебного автомобиля после экзамена в ГИБДД Архангельск' },
            { src: 'assets/gallery/photo2.jpg', alt: 'Фото учеников автошколы Мустанг с инструктором возле машины после успешной сдачи экзамена в Архангельске' },
            { src: 'assets/gallery/photo3.jpg', alt: 'Выпускники и инструкторы автошколы Мустанг около учебного автомобиля после экзамена в ГИБДД Архангельск' },
            { src: 'assets/gallery/photo4.jpg', alt: 'Ученики автошколы Мустанг с инструктором возле машины после экзамена в ГИБДД Архангельск' },
            { src: 'assets/gallery/photo5.jpg', alt: 'Фото учеников и инструкторов автошколы Мустанг около учебного автомобиля после успешной сдачи экзамена Архангельск' },
            { src: 'assets/gallery/photo6.jpg', alt: 'Выпускники автошколы Мустанг с инструктором возле машины после экзамена в ГИБДД Архангельск' },
            { src: 'assets/gallery/photo7.jpg', alt: 'Ученики и инструкторы автошколы Мустанг около учебного автомобиля после экзамена в ГИБДД Архангельск' },
            { src: 'assets/gallery/photo8.jpg', alt: 'Фото выпускников автошколы Мустанг с инструктором возле машины после успешной сдачи экзамена в Архангельске' },
        ];
    }
